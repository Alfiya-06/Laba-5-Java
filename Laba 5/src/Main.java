import cat.Cat;
import cat.MeowCounter;
import collections.ListMerger;
import collections.QueueBuilder;
import fractions.CachedFraction;
import fractions.Fraction;
import text.RussianLetter;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Создаём обычную дробь
        Fraction baseFraction = new Fraction(numerator, denominator);
        // Оборачиваем её в кэширующую обёртку
        CachedFraction fraction = new CachedFraction(baseFraction);
        ...
        ListMerger.mergeIntoFirst(L1, L2);
        ...
        try {
            int count1 = RussianLetter.countUniqueRussianLetters(fileName);
            System.out.println("Файл: " + fileName);
            System.out.println("Количество уникальных русских букв: " + count1);
        ...
        Queue<String> mirroredQueue = QueueBuilder.buildMirroredQueue(inputList);
